...
prob.solve(solver=MAT_FREE_POGS, verbose=True, max_iters=10000,
...
# prob.solve(solver=MAT_FREE_POGS, rho=1, verbose=True, abs_tol=1e-5, rel_tol=1e-4, max_iters=2499)
# print "POGS obj", prob.value
# print "POGS cost", cost.value
# print "ECOS obj", prob.solve(solver=ECOS)
